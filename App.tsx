...
const copy = {
  en: {
    ...
    last: "Latest recording", noRecording: "No recording has been finalized in this session.", open: "Open", reveal: "Show in folder", delete: "Delete", recordings: "Saved recordings", load: "Refresh library", emptyLibrary: "Your finalized local recordings will appear here.", created: "Created", duration: "Duration", sizeLabel: "Size", muxed: "System audio muxed", sidecar: "System WAV source retained",
  ...
  ar: {
    ...
    last: "أحدث تسجيل", noRecording: "لم يتم إنهاء أي تسجيل في هذه الجلسة.", open: "فتح", reveal: "إظهار في المجلد", delete: "حذف", recordings: "التسجيلات المحفوظة", load: "تحديث المكتبة", emptyLibrary: "ستظهر هنا تسجيلاتك المحلية التي تم إنهاؤها.", created: "تاريخ الإنشاء", duration: "المدة", sizeLabel: "الحجم", muxed: "تم دمج صوت النظام", sidecar: "تم الاحتفاظ بمصدر WAV للنظام",
