...
const copy = {
  en: {
    ...
    last: "Latest recording", noRecording: "No recording has been finalized in this session.", open: "Open", reveal: "Show in folder", delete: "Delete", exportMp4: "Export MP4", exported: "MP4 export completed locally and was verified.", recordings: "Saved recordings", load: "Refresh library", emptyLibrary: "Your finalized local recordings will appear here.", searchLibrary: "Search recordings", sortNewest: "Newest", sortOldest: "Oldest", sortDuration: "Longest", sortSize: "Largest", sortName: "Name", created: "Created", duration: "Duration", sizeLabel: "Size", muxed: "System audio muxed", sidecar: "System WAV source retained",
